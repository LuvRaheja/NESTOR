...
def get_cluster_details(region):
        ...
        try:
            ...
            if response['DBClusters']:
                ...
                if not cluster.get('HttpEndpointEnabled', False):
                    ...
                    print("Tip: Run: aws rds modify-db-cluster --db-cluster-identifier alex-aurora-cluster --enable-http-endpoint --apply-immediately")
                    return None, None
            else:
            ...
            print(f"[WARN] Could not verify cluster status: {e}")
    ...
    print("[WARN] AURORA_CLUSTER_ARN or AURORA_SECRET_ARN not found in .env file")
    print("Tip: After running 'terraform apply', add these to your .env file:")
    ...
    try:
        ...
        if not aurora_secrets:
            ...
            print("Tip: Look for a secret containing 'aurora' in the name")
            return None, None
...
def test_data_api(cluster_arn, secret_arn, region):
    ...
    try:
        ...
        if error_code == 'BadRequestException':
            ...
            print(f"   [WARN] Database 'alex' might not exist or credentials are incorrect")
    ...
    try:
        ...
        if tables:
            ...
            print("   Tip: Run the migration script to create tables")
